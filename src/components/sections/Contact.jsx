    ...
    <section id="contact" className="mx-auto max-w-7xl px-6 pb-20 pt-8 md:pb-28">
      <div className="animate-in rounded-[32px] border border-white/10 bg-[radial-gradient(circle_at_top_left,_rgba(0,240,255,0.12),transparent_30%),linear-gradient(135deg,#0d0f16,#090a0f)] p-8 shadow-[0_25px_80px_rgba(0,0,0,0.55)] md:p-10">
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
          ...
          <a href="mailto:tahamishaikh5@gmail.com?subject=Freelance%20Project%20Inquiry" className="inline-flex items-center justify-center rounded-full bg-gradient-accent px-6 py-3 text-sm font-semibold text-[#050507] shadow-[0_0_35px_rgba(0,240,255,0.25)] transition hover:translate-y-[-1px]">
            Book a freelance call
          </a>
        </div>
